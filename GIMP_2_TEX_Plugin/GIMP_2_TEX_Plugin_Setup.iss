...
Source: "libgomp-1.dll"; DestDir: "{code:GetGIMPPluginDir}"; Flags: ignoreversion; Tasks: fastcompression
Source: "libgcc_s_seh-1.dll"; DestDir: "{code:GetGIMPPluginDir}"; Flags: ignoreversion; Tasks: fastcompression
Source: "libstdc++-6.dll"; DestDir: "{code:GetGIMPPluginDir}"; Flags: ignoreversion; Tasks: fastcompression
